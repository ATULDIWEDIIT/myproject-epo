...
namespace Digital.Core
{
    ...
    public class DataTableResultExt : ActionResult, IDataTableResult<List<DataTableRow>>
    {
        ...
        public DataTables DataTable { get; }
        public int V { get; }
        public int TotalCount { get; }
        public List<DataTableRow> GridViewData { get; }

        public DataTableResultExt(DataTables dataTable, int iTotalRecords = 0, int iTotalDisplayRecords = 0, List<DataTableRow> aaData = null)
